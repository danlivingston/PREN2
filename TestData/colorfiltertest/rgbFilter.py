...
def process_frame(frame):
    ...
    for color, ((lower_h, lower_s, lower_v), (upper_h, upper_s, upper_v), contour_color) in color_ranges.items():
        ...
        for contour in contours:
            ...
            cv2.drawContours(frame, [approx], 0, contour_color, -1)  # -1 füllt die Kontur aus
