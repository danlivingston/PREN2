...
def test_buzzer(status):
    ...
    try:
        logger.debug("100hz")
        loop.run_until_complete(sound.sound_start(100))
        loop.run_until_complete(asyncio.sleep(1))
        logger.debug("200hz")
        loop.run_until_complete(sound.sound_start(200))
        loop.run_until_complete(asyncio.sleep(1))
        logger.debug("300hz")
        loop.run_until_complete(sound.sound_start(300))
        loop.run_until_complete(asyncio.sleep(1))
        logger.debug("400hz")
        loop.run_until_complete(sound.sound_start(400))
        loop.run_until_complete(asyncio.sleep(1))
        logger.debug("500hz")
