...
# Frames für die linke und rechte Seite des Bildschirms
...
start_button = tk.Button(left_frame, text="Start", command=lambda: start_files(start_script_paths), bg="green", fg="white", font=('Arial', 20))
