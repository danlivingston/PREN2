...
def create_gui():
    ...
    global root, label
    root = tk.Tk()
    root.title("Bilderkennung Status")

    # Einstellen der Fenstergröße und -position
    screen_width = root.winfo_screenwidth()
    screen_height = root.winfo_screenheight()
    window_width = int(screen_width * 0.52)  # 55% der Bildschirmbreite
    ...
    label = tk.Label(root, text="Bilderkennung in Bearbeitung", font=("Arial", 40), fg="green")
