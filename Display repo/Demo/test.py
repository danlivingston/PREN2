...
try:
	...
	Motor2 = DRV8825(dir_pin=24, step_pin=23, enable_pin=4, mode_pins=(12, 16, 20))
	...
	Motor2.TurnStep(Dir='forward', steps=248, stepdelay=0.002)
	time.sleep(0.5)
	Motor2.TurnStep(Dir='backward', steps=248, stepdelay=0.002)
	Motor2.Stop()
